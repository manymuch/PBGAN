...
flags.DEFINE_integer("option", 5, "option for utils")
...
flags.DEFINE_integer("structure", 0, "0 for original,1 for binarized with batch norm,2 for binarized without batch norm")
